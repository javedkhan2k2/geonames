...
namespace Import.Geonames.org
{
    public static class Program
    {
        ...
        // Change the connectionstring property beofre proceeding
        private static string _connectionString = @"Data Source=KBL-MMD-ALAM;Initial Catalog=GeoNames.org;Integrated Security=true;";
        ...
        private static void BuildTables()
        {
            _tablesNames = new[]
            {
                ...
                //new ImportEntity(_tempFolderName, __baseUrl + "allCountries.zip"), // To download data for all countries uncomment
                new ImportEntity(_tempFolderName, __baseUrl + "AF.zip", tableName: "AllCountries"), // replace AF.zip file with the country you want to download the data.
                ...
                /** 
                 * There is a little difference in all countries alternatenames and a single country names
                *  When you are donwloading the single country alternatenames, then make sure to add two other columns as well, otherwise it will fail to import.
                *  
                **/
                //new ImportEntity(_tempFolderName, __baseUrl + "alternateNames.zip"), // This will download all countries alternateNames
                new ImportEntity(_tempFolderName, __baseUrl + "alternatenames/AF.zip", tableName: "alternatenames") // This only download one country alternatenames
            };
        }
        ...
        private static void ClearTable(string tableName)
        {
            ...
            try
            {
                using (var connection = new SqlConnection(_connectionString))
                {
                    ...
                    string clearTableSql = $"TRUNCATE TABLE [dbo].[{tableName}];";
        ...
        private static void BulkImport(ImportEntity importEntity)
        {
            ...
            string sqlCommand = $@"
BULK INSERT [dbo].[{importEntity.TableName}]  
